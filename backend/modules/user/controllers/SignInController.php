...
use backend\modules\user\models\ResendEmailForm;
use Yii;
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => [
                            'login', 'login-by-pass', 'request-password-reset', 'reset-password', 'oauth', 'activation', 'resend-email'
                        ],
                        'allow' => true,
                        'roles' => ['?']
                    ],
                    [
                        'actions' => [
                            'login', 'request-password-reset', 'reset-password', 'oauth', 'activation', 'resend-email'
                        ],
                        'allow' => false,
                        'roles' => ['@'],
