 ...
 * @var backend\modules\user\models\SignupForm $model
 */
            ...
            <div class="card mb-2">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <?php echo Html::submitButton(Yii::t('backend', 'Sign up'), ['class' => 'btn btn-primary btn-lg btn-block', 'name' => 'signup-button']) ?>
                    </div>
                </div>
            </div>
