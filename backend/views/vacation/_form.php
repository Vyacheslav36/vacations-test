...
use backend\assets\VacationAsset;
...
<div class="vacation-form">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <h4><?php echo Yii::t('backend', 'Vacation department') ?></h4>
                <?php echo $this->render('components/gridViewForInfo', [
                    'dataProvider' => $vacationsDataProvider
                ]); ?>
            </div>
        </div>
    </div>
